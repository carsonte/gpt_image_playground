...
export function safeDetails(value) {
  const allowed = {}
  for (const key of ['announcementId', 'blockId', 'version', 'deletedCount', 'endpoint', 'model', 'module', 'imageCount', 'inputLength', 'outputLength', 'upstreamStatus', 'message', 'concurrency', 'perIpConcurrency', 'perIpQueueLimit', 'position']) {
