...
ENV SIXONER_API_URL=https://sub.sixoner.com/v1
ENV SIXONER_MODEL=gpt-image-2
ENV SIXONER_2K_MODEL=gpt-image-2-2k
ENV SIXONER_4K_MODEL=gpt-image-2-4k
ENV CATAPI_API_URL=https://catapi.cc.cd/v1
ENV CATAPI_MODEL=gpt-image-2
ENV CATAPI_2K_MODEL=gpt-image-2-2k
ENV CATAPI_4K_MODEL=gpt-image-2-4k
ENV SENSENOVA_API_URL=https://token.sensenova.cn/v1
ENV SENSENOVA_MODEL=sensenova-u1-fast
ENV SENSENOVA_CONCURRENCY=2
